export class EditSchedule {
    ...
    main(schedule) {
        ...
        $(`#form-${this.field}`).before(
            ...
            "   Настройки показа\n" +
            '   <div class="tooltip tooltip-right group cursor-pointer flex">\n' +
            '   <span class="material-icons-outlined text-blue-400">info</span>\n' +
            '   <span class="tooltip__content opacity-0 invisible group-hover:visible group-hover:opacity-100">Действие определяется через вкл\\выкл. По умолчанию действие вкл при первом совпадении даты и времени</span>\n' +
            "   </div>\n" +
            "   </div>"
        );
                    ...
                    if (dataInput[i].dateStart && dataInput[i].dateStop) {
                        ...
                        $(".add_schedule__date")
                            ...
                            .replaceWith(
                                ...
                                '<span class="material-icons-outlined"> expand_more </span></i>' +
                                "</span>" +
                    ...
                    if (dataInput[i].break) {
                        ...
                        $(".add_schedule__break")
                            ...
                            .replaceWith(
                                ...
                                '<span class="material-icons-outlined"> schedule </span></i>' +
                                "</button>" +
                                "</div>"
                            );
                    }
        ...
        $(`#form-${this.field}`).before('<button type="button" class="schedule-add">' + '<span class="material-icons-outlined"> add_circle_outline </span>' + "</button>");
        ...
        let modal =
            ...
            '</select>' +
            '</div>' +
            '<a class="addProperty navigation-plus" href="#"><span class="material-icons-outlined mr-2"> add_circle_outline </span></i></a>' +
            '</div>' +
            '</div>' +
    ...
    deleteTime(button) {
        $(button)
            .parent()
            .replaceWith('<button type="button" class="add_schedule__time">' + '<span><span class="material-icons-outlined mr-2"> add_circle_outline </span></i>Добавить время</span></button>');
        this.saveChanges();
    }
    ...
    deleteDate(button) {
        $(button)
            .parent()
            .replaceWith('<button type="button" class="add_schedule__date">' + '<span><span class="material-icons-outlined mr-2"> add_circle_outline </span></i>Добавить дату</span></button>');
        this.saveChanges();
    }
    ...
    deleteBreak(button) {
        $(button)
            .parent()
            .replaceWith('<button type="button" class="add_schedule__break">' + '<span><span class="material-icons-outlined mr-2"> add_circle_outline </span></i>Добавить перерыв</span></button>');
        this.saveChanges();
    }
            ...
            if (key === "id") {
                ...
                $("#propertyAdder")
                    ...
                    .before(`<div class="navigation-wrapper" id="${key}">` +
                        ...
                        `</div>` +
                        '<a href="#" class="deleteProp navigation-del"><span class="material-icons-outlined"> schedule </span></a>' +
                        "</div>");
    ...
    getschedule() {
        return (
            ...
            '<span><span class="material-icons-outlined mr-2">add_circle_outline</span></i>Добавить время</span></button>' +
            '<button type="button" class="add_schedule__date">' +
            '<span><span class="material-icons-outlined mr-2"> add_circle_outline </span></i>Добавить дату</span></button>' +
            '<button type="button" class="add_schedule__break">' +
            '<span><span class="material-icons-outlined mr-2"> add_circle_outline </span></i>Добавить перерыв</span></button>' +
            "</div>" +
