...
- [ ] 1.1 Создать модель `FilterAP`
  - [ ] 1.1.1 Определить интерфейс FilterAPAttributes
  - [ ] 1.1.2 Создать схему FilterAPSchema
  - [ ] 1.1.3 **КРИТИЧНО:** Добавить `userAccessRelation: 'owner'`
  - [ ] 1.1.4 Настроить associations (owner: BelongsTo UserAP)
- [ ] 1.2 Создать модель `FilterColumnAP`
- [ ] 1.3 Добавить Sequelize адаптер
- [ ] 1.4 Добавить Waterline адаптер
- [ ] 1.5 Создать миграции
- [ ] 1.6 Добавить связи с UserAP и GroupAP
- [ ] 1.7 Регистрация моделей
...
- [ ] JSON поля сохраняются/загружаются правильно
